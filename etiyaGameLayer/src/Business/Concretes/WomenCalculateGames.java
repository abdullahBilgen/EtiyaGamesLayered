...
public class WomenCalculateGames implements GameCalculateService {

	@Override
	public double calculate(Gamer gamer, Game game) {
		if(2021-gamer.getDogumTarihi()<=70) {
			System.out.println(gamer.getIsim() + "Oyuncuus Yetiþkin bir bayan" + game.getName() + "Oyunun puanýnýn %70 ini alýr. Puan : " + game.getGamePoint() 
